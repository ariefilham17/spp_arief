...
class Pengeluaran extends ResourceController
{
    ...
    public function index()
    {
        ...
        $raw            = $this->model
            ...
            ->where('tbl_jenis.tipe', 3)
            ->where('(tbl_keuangan.deskripsi LIKE "%' . $search . '%" OR tbl_jenis.nama LIKE "%' . $search . '%" OR tbl_keuangan.debit LIKE "%' . $search . '%" OR tbl_keuangan.kredit LIKE "%' . $search . '%" )')
    ...
    public function create()
    {
        $data       = [
            ...
            'debit'         => $this->request->getVar('nominal'),
            'kredit'        => NULL,
        ...
        $response   = [
            ...
            'error'     => null,
            'messages'  => [
                'success'   => 'Berhasil Menambahkan Pengeluaran'
            ]
        ];
    ...
    public function update($id = null)
    {
        ...
        $response   = [
            ...
            'error'     => null,
            'messages'  => [
                'success'   => 'Berhasil Mengubah Pengeluaran'
            ]
        ];
    ...
    public function delete($id = null)
    {
        ...
        if (!$data) {
            return $this->failNotFound('Pengeluaran Tidak Ditemukan');
        }

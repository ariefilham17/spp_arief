...
class Jenis_siswa extends ResourceController
{
    use ResponseTrait;

    protected $modelName = 'App\Models\SiswaKategoriModel';
    ...
    public function create()
    {
        ...
        $response   = [
            ...
            'error'     => null,
            'messages'  => [
                'success'   => 'Berhasil Menambahkan Jenis Siswa'
            ]
        ];
    ...
    public function update($id = null)
    {
        ...
        $exist       = $this->model->where('id !=', $id)->where('kode', $data['kode'])->where('status', 1)->first();
        if ($exist) {
            return $this->failNotFound('Kode sudah ada');
        }
        ...
        $response   = [
            ...
            'error'     => null,
            'messages'  => [
                'success'   => 'Berhasil Mengubah Jenis Siswa'
            ]
        ];
    ...
    public function delete($id = null)
    {
        ...
        if (!$data) {
            return $this->failNotFound('Jenis Siswa Tidak Ditemukan');
        }
        ...
        $response   = [
            ...
            'error'     => null,
            'messages'  => [
                'success'   => 'Berhasil Menghapus Jenis Siswa'
            ]
        ];
        return $this->respondCreated($response);
    }
